    ...
    <div class="interface">
      <div class="top">
        ...
        <!-- <div class="partner">
          <div class="person">
            <div class="pho">
              <img src="../../../../public/img/wpSimluate/Star.png" alt="" />
            </div>
            <span>Star</span>
          </div> 
          <div class="person">
            <div class="pho">
              <img src="../../../../public/img/wpSimluate/leon.png" alt="" />
            </div>
            <span>leon</span>
          </div>
          <div class="person">
            <div class="pho">
              <img src="../../../../public/img/wpSimluate/seon.png" alt="" />
            </div>
            <span>Seon</span>
          </div>
        </div> -->
...
.box {
  ...
  .prompt {
    width: 100%;
    height: 100%;
    background: url("/oraitStatic/img/wpSimluate/反馈完.png") no-repeat;
